...
export function renderOrderSummery() {
  ...
  cart.forEach((cartItem) => {
    ...
    const today = dayjs();
    const a = today.add(deliveryOption.deliveryDay, "days");
    const stringDate = a.format("dddd, MMMM D");

    checkoutHtml += `
    <div class="cart-item-container js-cart-item-container-${
      matchingProduct.id
    }">
        <div class="delivery-date">Delivery date: ${stringDate}</div>
...
`;
  ...
  function deliveryOptionsHtml(matchingProduct, cartItem) {
    ...
    />
    <div>
      <div class="delivery-option-date">${stringDate}</div>
  ...
  let deletBtn = document.querySelectorAll(".js-delete-btn");
